                     ...
                     <div class="cart-box">
                              ...
                              <div class="cart-content normal-good active">
                                ...
                                <div class="normal-box">
                                        <div class="cart-brand  good-pools-data" v-for="(item,index) in list" :key="index">
                                                <div class="good-list">
                                                        <div class="good-item">
                                                            <div class="opt">
                                                                ...
                                                                <div class="info">
                                                                    <div class="fixed-height">
                                                                        <div class="intro intro-name">
                                                                            ...
                                                                            <p class="color-size-row"><span class="color">颜色:{{item.color[selcolorIndex]}}</span><span class="size">尺码:{{item.size[selcolorIndex]}}</span></p>
                                                                        </div>
                                                                        <div class="intro intro-edit">
                                                                            <div class="edit-box">
                                                                                ...
                                                                                <div class="edit-size-info  edit-size-info-notop " @click="changeInfo(index)" :data-id="item.id"> 
                                                                                    <div class="txt">颜色:{{item.color[selSizeIndex]}} 尺码:{{item.size[selSizeIndex]}}</div>
                                                                                    <div class="down">
                              ...
                              <div class="cart-footer">
                                    ...
                                    <div class="opts edit">
                                        <div class="btn btn-red btn-del">删除</div>
                                    </div>
                                    <div class="opts bill ">
                                        <div class="total">
                              ...
                              <!-- 选择 -->
                             <div class="chose-panel" :class="{hide:isHide}"  @click="isHide=true">
                                        ...
                                        <div class="infos ">
                                            <div class="basic-info">
                                                ...
                                                <div class="text-info">
                                                    ...
                                                    <p class="choosed-info" :class="{hide:selected}">已选择:{{selcolor}},{{selSize}}</p>
                                            ...
                                            <div class="chose-items">
                                                ...
                                                <div class="num">
                                                    ...
                                                    <div class="clearfix">
                                                        <a class="btn btn-minus " href="javascript:void(0);"  @click="subtract" :data-id="list[specification].id">
                                                           -
                                                        </a>
                                                        <input id="good-num" class="good-num disabled" type="text" v-model:value="list[specification].num" disabled="true">
                                                            <a class="btn btn-plus" href="javascript:void(0);" @click="push"   :data-id="list[specification].id">
                                                                +
                                                            </a>
                                                    </div>
...
export default {
    data() {
        return {
            ...
            /*数据*/
              list:[ 
                   {id:1,title:'HUMAN MADE  海军蓝棒球帽',size:['F','S','M'],color:['海军蓝','草原绿'],price:449,info:'',num:3,url:"../../../static/img/cart/0001.jpg",},
                   {id:2,title:'Dickies 简约纯色长袖衬衫',size:['F','S','M'],color:['卡其色','黑色'],price:559,info:'',num:3,url:"../../../static/img/cart/0003.jpg"},
                   {id:3,title:'Dickies 简约纯色长袖衬衫',size:['F','S','M'],color:['卡其色','黑色'],price:559,info:'',num:3,url:"../../../static/img/cart/0003.jpg"},
                   {id:4,title:'FUTURA 系列 原子球印花滑板板面',size:['F','S','M'],color:['卡其色','黑色'],price:1089,info:'',num:3,url:"../../../static/img/cart/0002.jpg"},
              ]
        }
    },methods: {
        /* 修改确认 */
        affirm(){
            this.list[specification].color
        },
        /* 颜色选中 */
